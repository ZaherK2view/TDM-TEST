-- BE
INSERT INTO public.business_entities (be_name, be_description, be_id, be_created_by, be_creation_date, be_last_updated_date, be_last_updated_by, be_status) VALUES ('Customer360', 'This is a Business Entity created for the TDM GUI for free trail.', 1, 'admin', '2022-12-01 13:27:20.522', '2022-12-01 13:38:25.987', 'admin', 'Active')ON CONFLICT DO NOTHING;
...
INSERT INTO public.product_logical_units (lu_name, lu_description, be_id, lu_parent_id, lu_id, product_name, lu_parent_name, product_id) VALUES ('Billing', 'This is Customer Child LU.', 1, 1, 2, 'BILLING', 'Customer', 2) ON CONFLICT DO NOTHING;
INSERT INTO public.product_logical_units (lu_name, lu_description, be_id, lu_parent_id, lu_id, product_name, lu_parent_name, product_id) VALUES ('Asset', 'This is a Customer Child LU.', 1, 1, 3, 'ASSET', 'Customer', 3) ON CONFLICT DO NOTHING;
